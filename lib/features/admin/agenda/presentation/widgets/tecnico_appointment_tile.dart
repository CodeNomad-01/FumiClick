...
class AdminAppointmentTile extends StatelessWidget {
  final AdminAppointment cita;
  final VoidCallback? onTap;

  const AdminAppointmentTile({Key? key, required this.cita, this.onTap})
    : super(key: key);
    ...
    return Card(
      ...
      child: InkWell(
        ...
        child: Padding(
          ...
          child: _AdminAppointmentTileContent(cita: cita),
        ),
      ),
    );
  }
...
class _AdminAppointmentTileContent extends StatefulWidget {
  final AdminAppointment cita;
  const _AdminAppointmentTileContent({required this.cita});

  @override
  State<_AdminAppointmentTileContent> createState() =>
      _AdminAppointmentTileContentState();
}

class _AdminAppointmentTileContentState
    extends State<_AdminAppointmentTileContent> {
  late String _estado;
